...
% '/Users/sgardy/Documents/SarahData/Imagery/Data/rawEEG';
files = dir('par_*');             % <-- names of the folders
...
%% First script using prepro_eegfmri_1
...
%% Third script using prepro_epoching_Jude
% 
...
% cd('/Users/sgardy/Documents/SarahData/Imagery/Data/rawEEG/')
% csvfile = "/Users/sgardy/Documents/SarahData/Imagery/Data/rawEEG/order1.csv"
markerStrings = {{'S  2'}};
condStrings   = {'oth','neu','contam','surv','rew','ero','PerNeu','PerPl','PerUn'};
filename = "*_afterICA2_prepro2"
resampleTo = 500;
segTimesMs = [-1000 20000];

% for subindex = 1:min(numel(folderNames))
%     thisFolder = fullfile(datafolder, folderNames{subindex})
%     setfile = dir(fullfile(thisFolder, '*prepro2.set'))
...
% switch between order1 and order2
...
for k = 1:numel(setfile)
    ...
    LB3_prepro_epoching_gaborgen_sg(thisFolder, setfile(k).name, csvfile, markerStrings, condStrings, resampleTo, segTimesMs)
end
